...
import 'package:school_management_system/Backend/FileManager.dart';
...
late String homeWorkReferenceURL = 'users/' + authInstance.currentUser!.uid + '/';
...
void updateReferences(String uuid) {
  homeWorkReferenceURL = 'users/' + authInstance.currentUser!.uid + '/1p.jpg';
